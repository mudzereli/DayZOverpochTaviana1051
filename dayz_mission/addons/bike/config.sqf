...
DZE_DEPLOYABLES_CONFIG = [
    ...
    ["ItemToolbox",[0,2,1],5,0.1,false,false,false,false,false,true,true,["MMT_Civ"],[],["PartGeneric"],"true"],
    ...
    ["ItemToolbox",[0,5,2],7,0.1,true,true,false,false,false,true,true,["CSJ_GyroC"],[],["PartVRotor","PartEngine","PartFueltank"],"true"]

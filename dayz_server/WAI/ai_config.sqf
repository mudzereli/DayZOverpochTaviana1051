...
ai_add_humanity 			= 0;			// Amount of huminity gained for killing an AI
ai_banditkills_gain 		= false;			// Add kill to bandit kill score
...
ai_skill_medium 			= [["aimingAccuracy",0.75], ["aimingShake",0.60], ["aimingSpeed",0.60], ["endurance",1.00], ["spotDistance",0.60], ["spotTime",0.60], ["courage",1.00], ["reloadSpeed",1.00], ["commanding",1.00], ["general",1.00]];	// Medium
ai_skill_easy				= [["aimingAccuracy",0.65], ["aimingShake",0.50], ["aimingSpeed",0.50], ["endurance",1.00], ["spotDistance",0.50], ["spotTime",0.50], ["courage",1.00], ["reloadSpeed",1.00], ["commanding",1.00], ["general",1.00]];	// Easy
